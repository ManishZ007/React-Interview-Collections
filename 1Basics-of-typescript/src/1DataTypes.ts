// String ->
let greeting: string = "Hello World"; // this is how we define string in typescript
...
// Number ->
console.log("\nNumber Operations");
let num: number = -45.6789; // this is how we define number in typescript
...
// Boolean
console.log("\nBoolean");
let isActive: boolean = true; // this is how we define boolean in typescript
...
// Array
console.log("\nArray");
let numbers: number[] = [1, 2, 3, 4, 5]; // this is how we define array in typescript
...
// Object
console.log("\nObject");
let person: { name: string; age: number } = { name: "Ravi", age: 25 }; // this is how we define object in typescript
...
// Null and Undefined
console.log("\nNull and Undefined");
let empty: null = null; // this is how we define null in typescript
let notAssigned: undefined = undefined; // this is how we define undefined in typescript
...
// Tuple
console.log("\nTuple");
let point: [number, number] = [10, 20]; // this is how we define tuple in typescript
...
enum Color {
  ...
  Green,
  Blue,
} // this is how we define enum in typescript
console.log(Color.Green); // that gives the numeric value
console.log(Color[1]); // that gives the name from the value

// Any / Unknown
console.log("\nAny / Unknown");
let flexible: any = "could be anything"; // this is how we define any in typescript
let cautious: unknown = 42; // this is how we define unknown in typescript
